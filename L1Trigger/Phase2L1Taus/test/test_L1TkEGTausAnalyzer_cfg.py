...
# Schedule definition
process.schedule = cms.Schedule(process.L1simulation_step, process.L1TrackTrigger_step, process.pL1EG, process.pL1EGHGCal, process.pL1TkEGTausProd, process.pL1TkEGTausAna)
